...
# Overlap threshold for an RoI to be considered backgroun/
...
_C.MODEL.ROI_GRAPH_HEAD = CN()
_C.MODEL.ROI_GRAPH_HEAD.FEATURE_EXTRACTOR = "graphRCNNFeatureExtractor"
_C.MODEL.ROI_GRAPH_HEAD.BB_PAD = 0.1
_C.MODEL.ROI_GRAPH_HEAD.EDGES = True
_C.MODEL.ROI_GRAPH_HEAD.KGNN2D = False
_C.MODEL.ROI_GRAPH_HEAD.KGNN3D = False
_C.MODEL.ROI_GRAPH_HEAD.SHARE_BOX_FEATURE_EXTRACTOR = True
_C.MODEL.ROI_GRAPH_HEAD.DIMS = 3
_C.MODEL.ROI_GRAPH_HEAD.ENCODER_HIDDEN = 512
_C.MODEL.ROI_GRAPH_HEAD.DECODER_HIDDEN = 512
_C.MODEL.ROI_GRAPH_HEAD.EDGE_TYPES = 2
_C.MODEL.ROI_GRAPH_HEAD.ENCODER_DROPOUT = 0.5
_C.MODEL.ROI_GRAPH_HEAD.ENCODER_FACTOR = False
_C.MODEL.ROI_GRAPH_HEAD.DECODER_DROPOUT = 0.5
_C.MODEL.ROI_GRAPH_HEAD.SKIP_FIRST = False
_C.MODEL.ROI_GRAPH_HEAD.PARAMS_3D = 12
# ---------------------------------------------------------------------------- #
