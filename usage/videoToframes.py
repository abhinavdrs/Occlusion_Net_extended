"""
videoToframes.py takes a video as input and stores extracted frames in Occlusion_Net/demo folder.
...
def main():
    ...
    path_to_video = parsed_args.path
    path_to_frames = os.path.dirname(os.getcwd()) + '/demo'
    video_to_frames(video_path=path_to_video, frames_dir=path_to_frames, overwrite=False, every=1, chunk_size=1000)
